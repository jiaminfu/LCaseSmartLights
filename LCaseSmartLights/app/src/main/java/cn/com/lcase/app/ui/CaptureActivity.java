...
import cn.com.zxing.decode.DecodeThread;
...
//        bundle.putString("result", rawResult.getText());
        ...
        if (getIntent().hasExtra("main")) {
            intent.putExtra("device_id", rawResult.getText().toString().trim());
            setResult(RESULT_OK, intent);
        } else {
            if (rawResult.getText().contains("DY:")) {
                String s = rawResult.getText().split(":")[1];
                intent.putExtra("result", s);
                intent.setClass(CaptureActivity.this, RegisterViceActivity.class);
                startActivity(intent);
            } else {
                intent.putExtra("result", rawResult.getText().toString());
                intent.setClass(CaptureActivity.this, RegisterMainActivity.class);
                startActivity(intent);
            }
        }
        finish();
