...
public class RegisterMainActivity extends BaseActivity implements TextWatcher {
    ...
    private String email, phone, code, pwd, repwd,controlCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initListeners();
        initData();
        controlCode = getIntent().getStringExtra("result");
    }
    ...
    public void afterTextChanged(Editable s) {
        boolean a = etEmail.getText().toString().trim().length() > 6;
    ...
    private void toRegister() {
        ...
        new LCaseApiClient().saveUser(user).enqueue(new Callback<ReturnVo<Object>>() {
            @Override
            public void onResponse(Call<ReturnVo<Object>> call, Response<ReturnVo<Object>> response) {
                if (response.body() != null && response.body().isSuccess()) {
